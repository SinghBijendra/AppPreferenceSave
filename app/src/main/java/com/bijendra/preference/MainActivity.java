package com.bijendra.preference;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSavedNumber= (TextView) findViewById(R.id.tv_saved_number);
        ...
        findViewById(R.id.bt_save_text).setOnClickListener(this);
        findViewById(R.id.bt_save_number).setOnClickListener(this);
        findViewById(R.id.bt_force_close).setOnClickListener(this);
